...
public:
    ...
    inline array_type_ getRoot() const
    {
        return DA_ROOT;
    }
...
private:
    ...
    inline array_type_ getTailIndex(int s) const
    {
    ...
    inline void setTailIndex(size_t s, int v)
    {
        _da.setBase(s, -v);
    }
